...
function renderCoachWeekThreeCard() {
  ...
  if (!detail || detail.dataset.coachPresentation === 'true') return;
  detail.dataset.coachPresentation = 'true';
  detail.innerHTML = `<summary class="notebook-title"><div><span>Week 3 · Coach homework plan</span><h3>Session 2 build, field map, and robot movement</h3></div><strong>Due Wednesday, August 26</strong><em>Click to expand</em></summary>
    ...
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 4</span><h4>Model and robot interaction</h4><p>Pick one Session 2 model. What happens when the robot interacts with it, and what attachment, push, pull, or movement might be useful?</p></div></section>
