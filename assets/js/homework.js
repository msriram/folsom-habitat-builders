...
function renderCoachWeekThreeCard() {
  ...
  if (!detail || detail.dataset.coachPresentation === 'true') return;
  detail.dataset.coachPresentation = 'true';
  detail.innerHTML = `<summary class="notebook-title"><div><span>Week 3 · Coach homework plan</span><h3>Model build and Habitat Builders connection</h3></div><strong>Due Wednesday, August 26</strong><em>Click to expand</em></summary>
    <section class="notebook-cell"><div class="cell-prompt"><span>Coach context</span><h4>Reflect on Session 2 work</h4><p>Students look back at one model and connect their own biodiversity interest to the Habitat Builders team name. Field measurement work moves to Week 4.</p></div></section>
    ...
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 4</span><h4>Mission name and Spark connection</h4><p>Our team name is Habitat Builders. Which interest angle—such as invasive species, rainforest protection, or another biodiversity idea—matters to the student? How could Habitat Builders investigate or build something that helps?</p></div></section>
