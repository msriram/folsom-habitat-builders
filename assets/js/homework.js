...
function renderCoachWeekThreeCard() {
  ...
  if (!detail || detail.dataset.coachPresentation === 'true') return;
  detail.dataset.coachPresentation = 'true';
  detail.innerHTML = `<summary class="notebook-title"><div><span>Week 3 · Coach homework plan</span><h3>Project Sparks and Challenge Story</h3></div><strong>Due Wednesday, August 26</strong><em>Click to expand</em></summary>
    <section class="notebook-cell"><div class="cell-prompt"><span>Coach context</span><h4>Choose a problem worth investigating</h4><p>Students use the notebook pages to identify a biodiversity problem worth exploring. Use their responses to find shared interests, useful research directions, and questions for the team—without choosing the project for them.</p></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 1</span><h4>Read Project Sparks</h4><p>Read the Project Sparks page and notice an idea that could become a meaningful biodiversity project.</p></div><div class="worksheet-preview-grid"><a class="worksheet-preview-card" href="assets/img/notebook/project-sparks.png" target="_blank" rel="noopener"><img src="assets/img/notebook/project-sparks.png" alt="Project Sparks notebook page" loading="lazy"><strong>Project Sparks ↗</strong><small>Click to enlarge</small></a></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 2</span><h4>Read Challenge Story</h4><p>Read the Challenge Story page and connect one idea to a real biodiversity problem or habitat.</p></div><div class="worksheet-preview-grid"><a class="worksheet-preview-card" href="assets/img/notebook/challenge-story.png" target="_blank" rel="noopener"><img src="assets/img/notebook/challenge-story.png" alt="Challenge Story notebook page" loading="lazy"><strong>Challenge Story ↗</strong><small>Click to enlarge</small></a></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 3</span><h4>Choose a Project Spark</h4><p>Which Project Spark or different idea interests the student most, and why?</p></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 4</span><h4>Describe a biodiversity problem</h4><p>What biodiversity problem would the student like the team to investigate, and who or what is affected?</p></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 5</span><h4>Set a research direction</h4><p>What existing solution, scientist, organization, or source should the team learn from?</p></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 6</span><h4>Bring a team question</h4><p>What question should the student bring to Session 3?</p></div></section>
    <section class="notebook-cell"><div class="cell-prompt"><span>Task 7</span><h4>Core Values · Discovery</h4><p>What is one new thing the student discovered this week, and what question do they want to investigate next?</p></div></section>
