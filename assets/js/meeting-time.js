...
const sessions = [
  ...
  { number: 4, date: '2026-09-04', title: 'Attachment planning, build, and first tests', summary: 'Measure the route, build a first attachment, and record controlled trials.', focus: 'Use the Week 4 wireframe to measure the field, build attachment version 1, run three controlled trials, and name the evidence-based revision for Week 5.' },
  { number: 5, date: '2026-09-11', title: 'Build and test attachment version 2', summary: 'Turn the Week 5 sketch into a fitted attachment and a five-run test record.', focus: 'Build the planned attachment version, keep the home base and reset fixed, record five comparable trials, and use the evidence to choose the next change.' },
