...
const sessions = [
  ...
  { number: 2, date: '2026-08-21', title: 'Build, measure, and establish Rainforest Rangers', summary: 'Continue builds, measure the board, and map a useful distance to repeatable motor movement.', focus: 'Build more models, measure the table and robot, run early trials, and record what Rainforest Rangers means to the team.' },
  { number: 3, date: '2026-08-28', title: 'Build, test, and BIOGLOW link', summary: 'Finish more models, improve measurements, and begin repeatable robot trials.', focus: 'Finish more mission models, check the measurements that matter, run repeatable robot trials, and connect Rainforest Rangers to a specific BIOGLOW question.' },
  { number: 4, date: '2026-09-04', title: 'Model recap and mission trial runs', summary: 'Recap models, practice Missions 1, 3, 5, and 6, and begin Mission 13.', focus: 'Review the completed mission models, record observations from Mission 1, 3, 5, and 6 trial runs, and organize the partial Mission 13 build.' },
  { number: 5, date: '2026-09-18', title: 'Finish the carried-over field builds', summary: 'Build the M8/M9 tree house, M13–M15 bases, and remaining Mission 13 and 15 steps.', focus: 'Finish the model-building work carried from Session 4: build the tree house and M13–M15 field models, verify placement and reset, then record any remaining step before attachment work resumes.' },
  { number: 6, date: '2026-09-25', title: 'Build and test a mission attachment', summary: 'Build the planned change, check measurements, and compare five controlled runs.', focus: 'Build the Week 6 attachment or code change, check the planned measurements, run five controlled trials, and capture one specific revision target.' },
  { number: 7, date: '2026-10-02', title: 'Build and compare an attachment revision', summary: 'Compare the old and revised attachment fairly, then decide keep, revise, or defer.', focus: 'Build only the planned revision, hold the route and reset constant, compare it with the old version, and let the decision rule determine the next step.' },
  { number: 8, date: '2026-10-09', title: 'Build and test an integrated attachment run', summary: 'Run a controlled ten-trial sequence and decide whether it is ready to keep.', focus: 'Use the Week 8 sequence and reset plan to build or refine the attachment, record ten controlled trials, and decide from the pattern whether the run is ready.' },
  { number: 9, date: '2026-10-16', title: 'Impact and mission strategy', summary: 'Explain project impact, choose a mission strategy, and record the next improvement.', focus: 'Connect the project to real impact and choose robot missions that fit a reliable, timed strategy.' },
  { number: 10, date: '2026-10-23', title: 'Presentation draft', summary: 'Outline and rehearse the project presentation with clear evidence.', focus: 'Shape the team story around problem, research, solution, and impact while practicing a full robot run.' },
  { number: 11, date: '2026-10-30', title: 'Robot design explanation', summary: 'Prepare build, code, and testing evidence along with a short team celebration.', focus: 'Practice explaining how the robot was built, coded, and improved, with every student ready to share evidence.' },
  { number: 12, date: '2026-11-06', title: 'Full event rehearsal', summary: 'Practice judging, robot explanations, and event-day preparation.', focus: 'Rehearse the complete event experience, use recovery plans, and finish with a focused readiness checklist.' },
];
...
if (sessionNumber) {
  ...
  if (sessionNumber < sessions.length) {
    const homeworkWeek = sessionNumber;
