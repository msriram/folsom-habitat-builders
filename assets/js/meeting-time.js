...
const sessions = [
  ...
  { number: 5, date: '2026-09-11', title: 'Finish the carried-over field builds', summary: 'Build the M8/M9 tree house, M13–M15 bases, and remaining Mission 13 and 15 steps.', focus: 'Finish the model-building work carried from Session 4, verify every model can be placed and reset, and record any remaining build step before attachment work resumes.' },
  { number: 6, date: '2026-09-18', title: 'Build and test a mission attachment', summary: 'Build the planned change, check measurements, and compare five controlled runs.', focus: 'Build the Week 6 attachment or code change, check the planned measurements, run five controlled trials, and capture one specific revision target.' },
  { number: 7, date: '2026-09-25', title: 'Build and compare an attachment revision', summary: 'Compare the old and revised attachment fairly, then decide keep, revise, or defer.', focus: 'Build only the planned revision, hold the route and reset constant, compare it with the old version, and let the decision rule determine the next step.' },
  { number: 8, date: '2026-10-02', title: 'Build and test an integrated attachment run', summary: 'Run a controlled ten-trial sequence and decide whether it is ready to keep.', focus: 'Use the Week 8 sequence and reset plan to build or refine the attachment, record ten controlled trials, and decide from the pattern whether the run is ready.' },
