...
const fallbackAssignments = {
  ...
  4: { title: 'Dock strategy and keystone species', due: 'Wednesday, September 9', priority: 'Use Session 4 to connect a mission strategy to a biodiversity idea and record the team decision.' },
  5: { title: 'Research and existing solutions', due: 'Wednesday, September 16', priority: 'Bring one reliable source, one existing solution, and one expert or user question to Session 5.' },
