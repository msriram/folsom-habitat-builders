...
Object.assign(fallbackAssignments, {
  4: { title: 'Model build and attachment plan', due: 'Wednesday, September 2', priority: 'Make a clear attachment sketch, plan a route from home base, and identify the measurements the team needs before Session 4.' },
  5: { title: 'Attachment version 2 plan', due: 'Wednesday, September 9', priority: 'Design the next attachment change and write the five-run test that Session 5 will perform.' },
...
Object.assign(notebookHomework, {
  5: { session: 5, reflects: 4, title: 'Attachment version 2 plan', link: 'meeting-05.html', questions: [['attachment_target', 'Choose one model or robot action for Session 5. What must the attachment accomplish, and where exactly should it contact the model?'], ['attachment_sketch', 'Draw the next attachment version. Label the contact point, motion direction or angle, and the part of the base robot where it attaches. Describe your drawing in words.'], ['route_plan', 'Choose a home base and write the route to the model in order. Include the approach direction and one place where the robot must slow down, square up, or turn.'], ['five_run_test_plan', 'Write the Session 5 test plan: what will count as a successful run, what will the team record on each of five tries, and what one change will you make if the first version fails?']] },
