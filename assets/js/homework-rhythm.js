...
const fallbackAssignments = {
  ...
  2: { title: 'Build, measure, and map the field', due: 'Wednesday, August 26', priority: 'Continue the builds, measure the board, and connect distances to motor rotations where possible.' },
  3: { title: 'Project Sparks, Challenge Story, and Sequential Movements', due: 'Wednesday, September 2', priority: 'Choose a biodiversity problem, answer the project questions, and complete the Sequential Movements programming lesson with a screenshot and reflection.' },
  4: { title: 'Research and existing solutions', due: 'Wednesday, September 9', priority: 'Bring one reliable source, one existing solution, and one expert or user question to Session 5.' },
  5: { title: 'Solution plan and pseudocode', due: 'Wednesday, September 16', priority: 'Turn the team idea into a plan and a small robot program you can test.' },
  6: { title: 'Prototype and test', due: 'Wednesday, September 23', priority: 'Document a first prototype, what happened in testing, and the next change.' },
  7: { title: 'Feedback and iteration', due: 'Wednesday, September 30', priority: 'Use feedback to make one clear improvement to the project or robot.' },
  8: { title: 'Impact and mission strategy', due: 'Wednesday, October 7', priority: 'Explain the intended impact and the mission strategy that supports it.' },
  9: { title: 'Presentation draft', due: 'Wednesday, October 14', priority: 'Draft the team story, evidence, and one example of Coopertition.' },
  10: { title: 'Robot design explanation', due: 'Wednesday, October 21', priority: 'Explain the base robot, an attachment, and the code or testing evidence behind one choice.' },
  11: { title: 'Event rehearsal', due: 'Wednesday, October 28', priority: 'Practice the judging presentation and identify the section that needs one more rehearsal.' },
  12: { title: 'Final reflection and readiness', due: 'Wednesday, November 4', priority: 'Review goals, risks, packing, and the team’s final event plan.' }
};

const notebookHomework = {
  4: { session: 5, title: 'Research and existing solutions', page: 'Session 5 · Teamwork', link: 'meeting-05.html', questions: [['source','What reliable source, person, or organization did you learn from?'],['existing_solution','What existing solution did you find, and what did it teach you?'],['choice','Should we create something new or improve an existing solution? Explain.'],['expert_question','What question should we ask an expert or user?']] },
  5: { session: 6, title: 'Solution plan and pseudocode', page: 'Session 6 · Innovation', link: 'meeting-06.html', questions: [['solution_plan','What solution is the team planning, and what problem will it address?'],['steps','List the important steps, materials, or limits we should plan for.'],['pseudocode','Write simple pseudocode for one robot behavior we can test.'],['mission_test','Which mission program will you test next, and what will success look like?']] },
  6: { session: 7, title: 'Prototype and test', page: 'Session 7 · Gracious Professionalism', link: 'meeting-07.html', questions: [['prototype','Describe or attach the first project prototype.'],['evidence','How does the prototype help the people, animals, or habitat in the problem?'],['test_result','What happened when you tested it? Include one observation.'],['next_change','What is the next improvement to the prototype, robot, or attachment?']] },
  7: { session: 8, title: 'Feedback and iteration', page: 'Session 8 · Inclusion', link: 'meeting-08.html', questions: [['feedback_source','Who gave feedback, and what did they notice?'],['useful_feedback','What was the most useful feedback?'],['revision','What specific revision did you make because of it?'],['robot_iteration','What changed in a robot program or attachment after testing?']] },
  8: { session: 9, title: 'Impact and mission strategy', page: 'Session 9 · Impact', link: 'meeting-09.html', questions: [['intended_impact','What positive impact do you want the project to have?'],['mission_strategy','Which mission strategy best supports the team’s plan, and why?'],['reliability','What evidence shows the robot can repeat the mission?'],['next_improvement','What is the next improvement for the project or robot?']] },
  9: { session: 10, title: 'Presentation draft', page: 'Session 10 · Coopertition', link: 'meeting-10.html', questions: [['story_outline','What is the beginning, middle, and end of the team’s five-minute story?'],['evidence','What picture, test result, source, or model will make the story clear?'],['coopertition','Describe one example of helping another team or learning from one.'],['contribution','What part of the presentation will you help prepare?']] },
  10: { session: 11, title: 'Robot design explanation', page: 'Session 11 · Fun', link: 'meeting-11.html', questions: [['base_robot','What is one important choice in the base robot design?'],['attachment_code','Explain one attachment or code choice and its purpose.'],['test_revision','What did a test teach you, and what did you change?'],['team_fun','What has been fun about building or solving together?']] },
  11: { session: 12, title: 'Event rehearsal', page: 'Session 12 · Event Time', link: 'meeting-12.html', questions: [['presentation_reflection','What part of the judging presentation feels strongest?'],['weakest_section','Which section needs more practice?'],['recovery_plan','What will you do if something does not work during a match or presentation?'],['coach_question','What question do you want to ask the coach before the event?']] },
  12: { session: 12, title: 'Final reflection and readiness', page: 'Event preparation · Rubrics and scoresheets', link: 'meeting-12.html', questions: [['biggest_learning','What is the biggest thing you learned this season?'],['remaining_risk','What is the one remaining risk the team should manage?'],['packing','What should be on the final robot, project, and presentation checklist?'],['team_goal','What is the team’s goal for the event, and how will you support it?']] }
};
...
function applyRhythm() {
  ...
  Object.entries(notebookHomework).forEach(([weekNumber, assignment]) => {
    ...
    detail.innerHTML = `<summary class="notebook-title"><div><span>Week ${weekNumber} · Session ${assignment.session}</span><h3>${assignment.title}</h3></div><strong>Due ${fallbackAssignments[weekNumber].due}</strong><em>Click to expand</em></summary><section class="notebook-cell"><div class="cell-prompt"><span>Read the Engineering Notebook</span><h4>${assignment.page}</h4><p>Read the matching session pages, then answer these questions in your own words. This is preparation for the connected session—not a graded test.</p><a class="button secondary" href="${assignment.link}">Open Session ${assignment.session} plan →</a> · <a href="downloads/bioglow/engineering-notebook.pdf" target="_blank" rel="noopener">Open Engineering Notebook ↗</a></div></section><form class="homework-submit notebook-response" data-homework-form data-week-number="${weekNumber}" hidden><div class="section-title"><div><span class="eyebrow">Your response</span><h3>Week ${weekNumber} submission</h3></div><span class="status-chip" data-submit-status>Not submitted</span></div>${fields}<div data-existing-files class="submission-files"></div><button class="button primary" type="submit">Submit Week ${weekNumber} homework</button><p data-homework-message aria-live="polite"></p></form>`;
