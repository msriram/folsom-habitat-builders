...
Object.assign(notebookHomework, {
  5: { session: 5, reflects: 4, title: 'Model build inspiration and project curiosity', link: 'meeting-05.html', questions: [['session4_observation', 'Session 4 was an early build-and-test session. What did your group try, measure, or notice? Name one thing that still needs work; it is okay if nothing is working reliably yet.'], ['build_contribution', 'For Session 5, which remaining build could you help with: the M8/M9 tree house, M13 or M15, or a base for M13–M15? What small job, part, or reset check could you take responsibility for?'], ['innovation_question', 'Ask one real question about a local biodiversity problem the Habitat Builders could investigate. Why does this question matter to people, animals, plants, or a habitat?'], ['inspiration_to_share', 'Watch the SPIKE build reference and one inspiration video below. What one idea could the team adapt—not copy—for a base robot or attachment? It could be a sturdy mount, simple lift, guide, pusher, grabber, or quick-change connection. Explain how it might help our current models.']] },
  6: { session: 6, reflects: 5, title: 'Mission attachment and test plan', link: 'meeting-06.html', questions: [['mission_action_plan', 'Choose the next model or scoring action. What should the robot and attachment each do, in order, from leaving home base to completing the action?'], ['attachment_change_plan', 'Sketch or describe the attachment change you want to build in Session 6. What problem from the last version does this change solve?'], ['measurement_check', 'List the two measurements, alignments, or sensor readings the team must check before running the new version.'], ['test_record_plan', 'Write a five-run test table in words: what will you record for every try, and what result would prove the new version is better than the old one?']] },
