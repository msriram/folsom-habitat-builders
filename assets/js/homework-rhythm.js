...
const fallbackAssignments = {
  ...
  2: { title: 'Build, measure, and map the field', due: 'Wednesday, August 19', priority: 'Continue the builds, measure the board, and connect distances to motor rotations where possible.' },
